...
Hosted preview pages, the CTA prefill smoke page, the CTA link smoke page, the analytics smoke page, the layout smoke page, the WordPress inline embed, the WordPress smoke validator, the WordPress launch packet, the builder JSON fetches, and the pasteable README snippet use a shared static asset cache token, currently `jsuw-prod-20260603b`, on JS/CSS/JSON references. When hosted assets or GitHub Pages JSON/config should force-refresh for staff or public reviewers, run `node bump-cache-token.js jsuw-prod-YYYYMMDDx`, then run `node check-production.js`. The helper updates `index.html`, `embed-example.html`, `builder.html`, `cta-prefill-smoke.html`, `cta-link-smoke.html`, `analytics-smoke.html`, `layout-smoke.html`, `wrapped-builder.js`, `wordpress-inline-embed.html`, `wordpress-smoke.js`, `README.md`, `docs/production-readiness.md`, `docs/wordpress-launch-packet.md`, and `qa-smoke.js`.
...
<div
  id="jsu-wrapped"
  data-year="2026"
  data-source="https://stsimon-ncsy.github.io/jsu-wrapped-widget/sample-wrapped-2026.json?v=jsuw-prod-20260603b"
  data-config-source="https://stsimon-ncsy.github.io/jsu-wrapped-widget/wrapped-config-2026.json?v=jsuw-prod-20260603b"
  data-share-base="https://stsimon-ncsy.github.io/jsu-wrapped-widget/share/"
