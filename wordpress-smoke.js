...
const RELEASE_TOKEN = "jsuw-prod-20260609a";
...
function hostedShellCss() {
  return [
    "<style>",
    "html:has(#jsu-wrapped-wordpress-shell),body:has(#jsu-wrapped-wordpress-shell){margin:0;min-height:100%}",
    "body:has(#jsu-wrapped-wordpress-shell){overflow:hidden}",
    ...
    "#jsu-wrapped-wordpress-shell.jsuw-form-active,#jsu-wrapped-wordpress-shell.jsuw-picker-active{overflow-y:auto!important}",
    ...
    "#jsu-wrapped-wordpress-shell.jsuw-form-active .jsuw-page-stage,#jsu-wrapped-wordpress-shell.jsuw-picker-active .jsuw-page-stage{height:auto;justify-content:flex-start;min-height:100vh;min-height:100dvh;overflow:visible!important}",
    ...
    "#jsu-wrapped-wordpress-shell.jsuw-form-active #jsu-wrapped,#jsu-wrapped-wordpress-shell.jsuw-picker-active #jsu-wrapped{overflow:visible!important}",
    "#jsu-wrapped-wordpress-shell.jsuw-picker-active #jsu-wrapped{max-width:min(100%,720px)}",
    ...
    "#jsu-wrapped-wordpress-shell.jsuw-form-active .jsuw-legal,#jsu-wrapped-wordpress-shell.jsuw-picker-active .jsuw-legal{bottom:auto;left:auto;position:static;right:auto}",
