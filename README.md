...
<div
  ...
  data-teen-source="https://stsimon-ncsy.github.io/jsu-wrapped-widget/sample-teen-wrapped-2026.json?v=jsuw-prod-20260603b"
...
<link rel="stylesheet" href="https://stsimon-ncsy.github.io/jsu-wrapped-widget/jsu-wrapped.css?v=jsuw-prod-20260603b">
<script src="https://stsimon-ncsy.github.io/jsu-wrapped-widget/jsu-wrapped.js?v=jsuw-prod-20260603b"></script>
```
...
After pushing to GitHub Pages, run the hosted smoke check to confirm the live static files, builder script, WordPress inline embed, noindex QA pages, layout smoke page, teen proof-of-concept JSON, Baltimore share metadata, and social preview image are being served:
...
For a concise launch-gate summary, run:

```bash
node launch-audit.js
```

That command prints the automated local gates, post-deploy/live smoke commands, and manual confirmations that still need a human, including GA4 DebugView for `G-Y3LLF5KQ23`, a real Gravity Forms test submission, and mobile/desktop visual review.
