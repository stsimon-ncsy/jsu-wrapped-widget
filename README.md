...
The packet includes the current replacement `#jsu-wrapped` tag, exact page/social title, suggested `og:title`, `twitter:title`, `og:image`, `twitter:image`, and the follow-up smoke command.
